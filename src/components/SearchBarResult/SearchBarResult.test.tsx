...
const mockContextValueWithStock = {
  search: "Apple",
  bookedStocks: [],
...
describe("SearchBarResult works correctly", () => {
      ...
      <MemoryRouter>
        <AppContext.Provider value={mockContextValue}>
          <QueryClientProvider client={queryClient}>
            <SearchBarResult
              search={mockContextValueWithStock.search}
              stocks={mockContextValueWithStock.stocks}
              bookedStocks={mockContextValueWithStock.bookedStocks}
              onSearch={mockSetSearch}
            />{" "}
          </QueryClientProvider>
        </AppContext.Provider>
      </MemoryRouter>
  ...
  it("Data renders for stocks", () => {
    render(
      <MemoryRouter>
        <AppContext.Provider value={mockContextValueWithStock}>
          <QueryClientProvider client={queryClient}>
            <SearchBarResult
              search={mockContextValueWithStock.search}
              stocks={mockContextValueWithStock.stocks}
